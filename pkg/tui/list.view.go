...
func NewListsModel(listRepo repository.ProjectsRepository, tasksRepo repository.TasksRepository) listsModel {
	items := []list.Item{
	...
	m := listsModel{list: list.New(items, list.NewDefaultDelegate(), 0, 0)}
